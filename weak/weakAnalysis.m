...
for i = 1:1:nbFiles
	...
	if length(tmp) == 2
		...
		line = fgetl(file); % wipe out very first line "calling Python script"
...
legend('1 process', '4 processes', '7 processes', '10 processes', 'location', 'southeast');
xlabel('Number of threads per process');
ylabel('Computation time [s]');
lim = axis;
lim(3) = 0; % set y_min to 0
axis(lim)
% set(gca,'yscale','log')
grid
print(gcf,'scaling_weak_expl1','-depsc')
...
legend('1 thread/process', '8 thread/process', '16 thread/process', '24 thread/process', 'location', 'southeast');
...
% set(gca,'yscale','log')
grid
print(gcf,'scaling_weak_expl2','-depsc')
...
legend('1 process', '4 processes', '7 processes', '10 processes', 'location', 'northwest');
xlabel('Number of threads per process');
ylabel('Computation time [s]');
lim = axis;
lim(3) = 0; % set y_min to 0
...
% set(gca,'yscale','log')
grid
print(gcf,'scaling_weak_impl1','-depsc')
...
legend('1 thread/process', '8 thread/process', '16 thread/process', '24 thread/process', 'location', 'northwest');
xlabel('Number of processes');
ylabel('Computation time [s]');
lim = axis;
lim(3) = 0; % set y_min to 0
...
% set(gca,'yscale','log')
grid
print(gcf,'scaling_weak_impl2','-depsc')
